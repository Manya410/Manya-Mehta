...
expName = 'experiment-2'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\Hp\\OneDrive\\Desktop\\experiment-2_lastrun.py',
