...
expName = 'ManyaMehta_AU2020160_Tutorial.4'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\spong\\OneDrive\\Desktop\\ManyaMehta_AU2020160_Tutorial.4_lastrun.py',
